...
public class TopicosController {
    ...
    public Page<TopicoDto> lista(@RequestParam(required = false) String nomeCurso, 
            @RequestParam int pagina, @RequestParam int itensPorPagina, @RequestParam String ordenacao) {
 
        Pageable paginacao = PageRequest.of(pagina, itensPorPagina, Direction.ASC, ordenacao);
